/**
 * File admin-customize-background.js.
 *
 * Update the background image live when swiched in the cusomizer.
 */

import jQuery from 'jquery';

/**
 * @param {wp.customize} api The wp.customize object supplied by WordPress.
 */
( function( api ) {
	/**
	...
	api.controlConstructor[ 'background-image' ] = api.UploadControl.extend( {
		...
		ready: function() {
			...
			var imageUrl = this;
			imageUrl.setting = this.settings.image_url;
			api.UploadControl.prototype.ready.apply( imageUrl, arguments );
