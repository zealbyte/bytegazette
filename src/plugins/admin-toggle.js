...
( function( $ ) {
	$( document ).ready( () => {
		...
		$( '#input_header_bg_adv_link-show' ).click( () => {
		...
		$( '#input_header_bg_adv_link-hide' ).click( () => {
		...
		$( '#input_background_settings .button-select' ).change( () => {
